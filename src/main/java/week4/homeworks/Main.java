...
//        System.out.println(removeDuplicatesFromString(givenString));
    ...
    private static void printDuplicates(String givenString) {
//        char[] stringArray = givenString.toCharArray();
//
...
//        }
    ...
    private static boolean checkIfPalindrome(String givenString) {
    ...
    private static void countVowelsAndConsonants (String givenString) {
    ...
    private static int countOccurenceOfChar(char charToCheck, String givenString) {
        int charCount = 0;
        char[] stringArray = givenString.toCharArray();
    ...
    private static boolean checkIfAllCharsAreDigits(String givenString) {
        char[] stringArray = givenString.toCharArray();
    ...
    private static int convertStringToInt(String givenString) {
    ...
    private static String removeCharacterFromString(char character, String givenString) {
    ...
    private static void firstNonRepeatedCharacter(String givenString) {
        StringBuilder sb = new StringBuilder(givenString);
        boolean flag = false;
    ...
    private static String removeDuplicatesFromString(String givenString) {
    ...
    private static void findDuplicatesFromString(String givenString) {

    }
            //Write a method to check if two strings are anagrams of each other.
    private static void areAnagrams (String givenString1, String givenString2) {
